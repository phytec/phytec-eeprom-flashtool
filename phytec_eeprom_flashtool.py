...
def eeprom_read(i2c_bus, i2c_dev, addr, num_bytes):
	try:
		eeprom_file = open(i2c_cfg['eeprom_sysfs'], 'rb')
...
def eeprom_write(i2c_bus, i2c_dev, addr, string):
	try:
		eeprom_file = open(i2c_cfg['eeprom_sysfs'], 'wb')
		eeprom_file.seek(addr)
	...
	try:
		if args.dir != None:
			...
			cfg_path = \
				...
				+ cfg_dir
		config_file = open(cfg_path + args.som + '.ini','r')
